  ...
  return (
    <div className="space-y-2">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 px-5 py-3.5 bg-blue-50 dark:bg-[#0A66C2]/10 hover:bg-blue-100 dark:hover:bg-[#0A66C2]/20 text-[#0A66C2] dark:text-blue-300 text-[12px] font-bold uppercase tracking-widest rounded-full active:scale-[0.98] transition-all duration-300 shadow-sm border border-[#0A66C2]/20 dark:border-[#0A66C2]/30"
      >
      ...
      <button
        ...
        className="w-full text-xs text-gray-500 dark:text-gray-400 hover:text-cyan-600 dark:hover:text-cyan-400 font-medium transition-colors flex items-center justify-center gap-1"
      >
        <svg
        ...
        <div className="p-4 bg-white/60 dark:bg-gray-800/60 backdrop-blur-lg border border-gray-200/50 dark:border-gray-700/50 rounded-xl text-xs space-y-3 animate-slide-up">
          ...
          <ol className="space-y-2.5 text-gray-600 dark:text-gray-400 leading-relaxed">
            <li className="flex gap-2.5">
              <span className="flex-shrink-0 w-5 h-5 bg-cyan-100 dark:bg-cyan-900/40 text-cyan-600 dark:text-cyan-400 rounded-full flex items-center justify-center text-[10px] font-bold mt-0.5">1</span>
            ...
            <li className="flex gap-2.5">
              <span className="flex-shrink-0 w-5 h-5 bg-cyan-100 dark:bg-cyan-900/40 text-cyan-600 dark:text-cyan-400 rounded-full flex items-center justify-center text-[10px] font-bold mt-0.5">2</span>
            ...
            <li className="flex gap-2.5">
              <span className="flex-shrink-0 w-5 h-5 bg-cyan-100 dark:bg-cyan-900/40 text-cyan-600 dark:text-cyan-400 rounded-full flex items-center justify-center text-[10px] font-bold mt-0.5">3</span>
            ...
            <li className="flex gap-2.5">
              <span className="flex-shrink-0 w-5 h-5 bg-cyan-100 dark:bg-cyan-900/40 text-cyan-600 dark:text-cyan-400 rounded-full flex items-center justify-center text-[10px] font-bold mt-0.5">4</span>
            ...
            <li className="flex gap-2.5">
              <span className="flex-shrink-0 w-5 h-5 bg-cyan-100 dark:bg-cyan-900/40 text-cyan-600 dark:text-cyan-400 rounded-full flex items-center justify-center text-[10px] font-bold mt-0.5">5</span>
