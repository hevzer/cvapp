...
import { i18n, LanguageCode, languageOptions } from '../lib/i18n';
...
export default function ResumeBuilder() {
  ...
  const rawCvLang = useResumeStore((s) => s.resumeData.cvLanguage);
  const cvLang = (i18n[rawCvLang as LanguageCode] ? rawCvLang : 'en') as LanguageCode;
